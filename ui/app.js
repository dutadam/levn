...
import { loadAll } from "./shared.js?v=7";
import { initFinder } from "./finder.js?v=7";
import { initStudio, openRugInStudio } from "./studio.js?v=7";
import { initPalette } from "./palette.js?v=7";
